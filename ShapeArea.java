...
import java.util.Scanner;
 ...
 public class ShapeArea {
     public static void main( String[] args ) {
         ...
         do {
             ...
             if ( choice == 1 ) {
             	...
             	System.out.print("\nLength: ");
                 int lng = keyboard.nextInt();
                 System.out.print("Width: ");
                 int wdt = keyboard.nextInt();
                 System.out.println("The area of a square is " + computeSquareArea(lng, wdt));
             }
             else if ( choice != 5 ) {
     ...
     public static int computeSquareArea(int x, int y) {
     	return x * y;
     }
 }
